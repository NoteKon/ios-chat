...
#    ss.vendored_frameworks = 'SWToast/Frameworks/**/*.framework'
#    ss.vendored_libraries = 'SWToast/Frameworks/**/*.a'
#    # 远程第三方库
...
#    ss.resource_bundles = {
#      'SWToast' => [
#           'SWToast/Assets/SWToast.xcassets',
#           'SWToast/Assets/OtherResources/**/*.{storyboard,xib,xcassets,lproj,plist,json}'
#       ]
#    }
#  end
  ...
  s.subspec "File" do |ss|
    ss.source_files = 'SWToast/Classes/**/*'
#    ss.dependency 'SWToast/Resources'
#    ss.dependency 'SWToast/Dependency'
  end
  
  # Framework包依赖, 使用打包脚本打包后可用
  s.subspec "Framework" do |ss|
    ss.vendored_frameworks = 'SWToast.xcframework'
#    ss.dependency 'SWToast/Dependency'
