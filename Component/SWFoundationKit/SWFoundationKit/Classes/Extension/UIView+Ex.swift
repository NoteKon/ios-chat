...
//  SWFoundationKit
//
//  Created by ice on 2019/8/1.
//  Copyright © 2019 CocoaPods. All rights reserved.
//

import UIKit
extension UIView {
    /// SwifterSwift: Set some or all corners radiuses of view. 被设置的View要通过Frame初始化，不是通过AutoLayout布局
    /// 视图圆角，倒角
    ///
    /// - Parameters:
    ///   - corners: array of corners to change (example: [.bottomLeft, .topRight]).
    ///   - radius: radius for selected corners.
    public func addCorners(_ corners: UIRectCorner, radius: CGFloat) {
...
extension UIView {
    ...
    public func addGradientColor(startColor: UIColor,
                                 middleColor: UIColor,
                                 endColor: UIColor,
