...
// MARK:- SwitchCell
open class SwitchCell: SWTableCellOf<Bool> {
...
// MARK:- SwitchRow
open class _SwitchRow: SWTableRowOf<SwitchCell> {
    ...
    open override var value: SWTableCellOf<Bool>.Value? {
        didSet {
            updateSliderText()
        }
    }
...
///  带switch控件的Row，可展示标题和switch，同时提供自定义标题、switch样式和位置等属性
public final class SwitchRow: _SwitchRow, SWRowType {
}
