...
// MARK: TextViewCell
open class CollectionTextViewCell : SWCollectionCellOf<String> {
    ...
    open override func update() {
        ...
        markInput.inputTextView.text = text
...
// MARK: TextViewRow
open class _TextViewItemOf<T: CollectionTextViewCell> : SWCollectionItemOf<T> {
    open override var identifier: String {
        return "_TextViewItemOf\(T.self)"
    }
    ...
    public func onTextDidChanged(_ callBack: @escaping ((_ row: _TextViewItemOf<T>, _ newText: String) -> Void)) {
...
public final class TextViewItem: _TextViewItemOf<CollectionTextViewCell>, SWRowType{
}
