...
import UIKit
import SWPageControl

class ViewController: UIViewController {
    var pageControllers: [SWPageControl] = [SWPageControl]()
    ...
    func setupUI_1() {
        ...
        let pageControl = SWPageControl(frame: CGRect(x:110, y:150, width: 200, height: 20))
        ...
        pageControllers.append(pageControl)
    }
    
    func setupUI_2() {
        let pageControl = SWPageControl(frame: CGRect(x:110, y:200, width: 200, height: 20))
        view.addSubview(pageControl)
        pageControl.center = CGPoint(x: pageControl.superview!.center.x, y: pageControl.center.y)
    ...
    func setupUI_3() {
        ...
        let pageControl = SWPageControl(frame: CGRect(x:110, y:250, width: 200, height: 20))
        view.addSubview(pageControl)
        pageControl.center = CGPoint(x: pageControl.superview!.center.x, y: pageControl.center.y)
    ...
    func setupUI_4() {
        let pageControl = SWPageControl(frame: CGRect(x:110, y:300, width: 200, height: 20))
        view.addSubview(pageControl)
        pageControl.center = CGPoint(x: pageControl.superview!.center.x, y: pageControl.center.y)
