...
Pod::Spec.new do |s|
  s.name             = 'SWPageControl'
  s.version          = '1.0.0'
  s.summary          = 'SWPageControl组件库'
...
#    ss.vendored_frameworks = 'SWPageControl/Frameworks/**/*.framework'
#    ss.vendored_libraries = 'SWPageControl/Frameworks/**/*.a'
#    # 远程第三方库
...
#    ss.resource_bundles = {
#      'SWPageControl' => [
#           'SWPageControl/Assets/SWPageControl.xcassets',
#           'SWPageControl/Assets/OtherResources/**/*.{storyboard,xib,xcassets,lproj,plist,json}'
#       ]
#    }
#  end
  ...
  s.subspec "File" do |ss|
    ss.source_files = 'SWPageControl/Classes/**/*'
#    ss.dependency 'SWPageControl/Resources'
#    ss.dependency 'SWPageControl/Dependency'
  end
  
  # Framework包依赖, 使用打包脚本打包后可用
  s.subspec "Framework" do |ss|
    ss.vendored_frameworks = 'SWPageControl.xcframework'
#    ss.dependency 'SWPageControl/Dependency'
