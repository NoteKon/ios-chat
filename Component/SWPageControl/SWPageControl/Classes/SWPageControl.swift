...
//  xx
//
//  Created by ice on 2021/8/24.
//

import UIKit

public class SWPageControl: UIView {
    public var numberOfPages: Int = 0 {
        didSet {
            ...
            for _ in 0..<numberOfPages {
                let dotView = UIView()
                dotView.layer.cornerRadius = cornerRads
                addSubview(dotView)
    ...
    public var currentPage: Int {
        set {
            ...
            let dotCount = currentDotColorArr.count
            // 向右
            if (newValue > currentPage) {
                ...
                UIView.animate(withDuration: 0.3, animations: {
                    ...
                    if newValue < dotCount {
                        endView.backgroundColor = self.currentDotColorArr[newValue]
                    } else {
    ...
    public var cornerRads: CGFloat = 0
    public var currentDotColor: UIColor = .red
    public var currentDotColorArr: [UIColor] = [UIColor]()
